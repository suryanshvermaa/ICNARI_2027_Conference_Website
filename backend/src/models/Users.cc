...
Users::Users(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[4].empty() && pJson.isMember(pMasqueradingVector[4]))
    {
        ...
        {
            profilePictureObjectKey_=std::make_shared<std::string>(pJson[pMasqueradingVector[4]].asString());
        }
    }
...
const std::shared_ptr<std::string> &Users::getProfilePictureObjectKey() const noexcept
{
    return profilePictureObjectKey_;
}
    ...
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 7)
    {
        ...
        if(!pMasqueradingVector[4].empty())
        {
            if(getProfilePictureObjectKey())
            {
                ret[pMasqueradingVector[4]]=getValueOfProfilePictureObjectKey();
            }
            else
            {
...
bool Users::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("profile_picture_object_key"))
    {
        if(!validJsonOfField(4, "profile_picture_object_key", pJson["profile_picture_object_key"], err, true))
            return false;
    }
    if(pJson.isMember("created_at"))
    {
...
bool Users::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("profile_picture_object_key"))
    {
        if(!validJsonOfField(4, "profile_picture_object_key", pJson["profile_picture_object_key"], err, false))
            return false;
    }
    if(pJson.isMember("created_at"))
    {
