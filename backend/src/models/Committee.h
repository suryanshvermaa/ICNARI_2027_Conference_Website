...
class Committee
{
  public:
     ...
     */
    explicit Committee(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Committee(const Json::Value &pJson) noexcept(false);
     ...
     */
    Committee(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column college  */
    ///Get the value of the column college, returns the default value if the column is null
    const std::string &getValueOfCollege() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getCollege() const noexcept;
    ///Set the value of the column college
    void setCollege(const std::string &pCollege) noexcept;
    void setCollege(std::string &&pCollege) noexcept;
    void setCollegeToNull() noexcept;

    /**  For column committee  */
    ///Get the value of the column committee, returns the default value if the column is null
    const std::string &getValueOfCommittee() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getCommittee() const noexcept;
    ///Set the value of the column committee
    void setCommittee(const std::string &pCommittee) noexcept;
    void setCommittee(std::string &&pCommittee) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<Committee>;
    friend drogon::orm::BaseBuilder<Committee, true, true>;
    friend drogon::orm::BaseBuilder<Committee, true, false>;
    friend drogon::orm::BaseBuilder<Committee, false, true>;
    friend drogon::orm::BaseBuilder<Committee, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Committee>;
#endif
