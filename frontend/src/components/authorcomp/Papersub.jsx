    ...
    <div className="site-card w-full max-w-4xl mx-auto my-8 py-16">
      <section className="p-8">
        ...
        <ul className="list-disc pl-6 text-zinc-700 dark:text-slate-200 text-lg">
          ...
          <li><strong className="font-semibold">Paper Submission Deadline:</strong><span className='underline bg-amber-200 px-1 rounded dark:bg-amber-500/20 dark:text-amber-100'>December 18 (extended)</span></li>
          <li><strong className="font-semibold">Notification Acceptance:</strong> 25 January, 2027</li>
          <li><strong className="font-semibold">Date of Conference:</strong>March 6th - 8th, 2027</li>
          <li><strong className="font-semibold">Early Bird Registration:</strong>15 February, 2027</li>
          <li><strong className="font-semibold">Camera-Ready Submission:</strong>20 February, 2027</li>
          <li>
